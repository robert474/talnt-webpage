  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Our average time-to-fill for data center roles is 12-18 business days, approximately 40% faster than generalist staffing agencies. For urgent needs we maintain a bench of pre-vetted candidates in high-demand markets who can mobilize within 5-7 business days. Our speed comes from maintaining a specialized candidate database of over 15,000 data center professionals and leveraging deep industry relationships built over years of focused recruitment.",
      },
      {
        question:
